...
def main(cfg : DictConfig) -> None:
    ...
    # Handle the case where there's no cross-validation (empty eval_idx_list)
    if not eval_idx_list:
        print("No cross-validation configured. Evaluation requires fold-based setup.")
        print("Please set k_folds > 0 in benchmark config or use training mode instead.")
        exit(1)
